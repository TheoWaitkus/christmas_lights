...
colors = [(100,0,0),(0,100,0),(0,0,100),(150,100,0),(66,150,100),(100,50,150),(100,0,100),(100,10,40)]

def colorer(x,y,r,g,b, light_state, helper):
    for light in filter(angles((x)%64,(y)%64),coords):
        ...
        for j in range(iterations+1):
            for i in range(500):
                if(light_state.exit_thread):
                    ...
                    return
                if (i%2 == 0):
                    helper.change(i, int(gold[0] - j*gold[0]/iterations), int(gold[1]- j*gold[1]/iterations), int(gold[2]- j*gold[2]/iterations))
                else:
                    helper.change(i, int(silver[0] - j*silver[0]/iterations), int(silver[1]- j*silver[1]/iterations), int(silver[2]- j*silver[2]/iterations))
        ...
        for j in range(iterations+1):
            for i in range(500):
                if(light_state.exit_thread):
                    ...
                    return
                if (i%2 == 0):
                    helper.change(i, int(gold[0] - (iterations-1-j)*gold[0]/iterations), int(gold[1]- (iterations-1-j)*gold[1]/iterations), int(gold[2]- (iterations-1-j)*gold[2]/iterations))
                else:
                    helper.change(i, int(silver[0] - (iterations-1-j)*silver[0]/iterations), int(silver[1]- (iterations-1-j)*silver[1]/iterations), int(silver[2]- (iterations-1-j)*silver[2]/iterations))
